...
## compile slides
mdslides compile config.yaml src/ tmp/ --chapter-title=img --glossary=glossary.yaml
## build presentation
...
# build reveal.js
mdslides compile config.yaml src/ tmp/ --chapter-title=text --glossary=glossary.yaml
...
mdslides compile config.yaml src/ tmp/ --chapter-title=none --glossary=glossary.yaml
