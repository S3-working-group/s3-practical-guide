---
title: "Domains and Delegation"
next_page_title: "Objections"
next_page_url: "objection.html"
prev_page_title: "A Model for Purposeful Action"
prev_page_url: "purposeful-action.html"
---
...
[Clarifying domains](clarify-and-develop-domains.html) makes the contract between the *delegator* (who delegates responsibility for a domain) and the *delegatee(s)* (to whom the domain is delegated) explicit, which enables everyone to understand expectations and to reflect on what works and what doesn't, so that a domain's design can be improved over time. A clear domain description with a reasonable amount of detail is a necessary prerequisite for people to successfully evaluate and continuously improve their work.
...
See [Clarify and Develop Domains](clarify-and-develop-domains.html) for more details.
