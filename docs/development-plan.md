...
Development may happen in the form of refining the [description of the driver](describe-organizational-drivers.html) and the <a href="glossary.html#entry-domain" class="glossary-tooltip" data-toggle="tooltip" title="Domain: A distinct area of responsibility and authority within an organization.">domain</a>, making amendments to <a href="glossary.html#entry-strategy" class="glossary-tooltip" data-toggle="tooltip" title="Strategy: A high-level approach for how people will fulfill the purpose of a domain (within the constraints of that domain).">strategy</a>, or new or updated policies and specific actions to be taken, either within the domain of the delegator, or the domain of the delegatee.
