---
title: "A Model for Purposeful Action"
next_page_title: "Domains and Delegation"
...
-   Understanding a situation well is essential for determining what's required to address it adequately (see [Respond to Organizational Drivers](respond-to-organizational-drivers.html)).
-   Investigating a situation before acting helps avoid mistaken assumptions (see [Navigate via Tension](navigate-via-tension.html)).
-   Describing a driver is an effective way of communicating with others, ensuring a shared understanding of the situation and why we must act (see [Describe organizational Drivers](describe-organizational-drivers.html)).
...
See [Describe Organizational Driver](describe-organizational-drivers.html) for more examples.
...
For more guidance on how to describe organizational drivers clearly and effectively, see the [Describe Organizational Drivers](describe-organizational-drivers.html) pattern.
...
-   [Describe Organizational Drivers](describe-organizational-drivers.html) offers guidance on how to describe organizational drivers clearly and effectively.
-   [Respond to Organizational Drivers](respond-to-organizational-drivers.html) explains the steps for responding to organizational drivers.
...
-   [Determine Requirements](determine-requirements.html)
-   [Evaluate and Evolve Policy](evaluate-and-evolve-policy.html)
...
Policies are discussed in more detail in the chapter about [Governance, Operations, and Policy](governance-operations-and-policy.html), but a brief introduction is helpful in the context of the model.
...
-   [Proposal Forming](proposal-forming.html) and [Co-Create proposals](co-create-proposals.html) for co-creating solutions based on collective input.
-   [Consent Decision Making](consent-decision-making.html) — for surfacing and addressing objections against a possible intervention before implementing it.
-   [Evaluate and Evolve policies](evaluate-and-evolve-policies.html) to support continuous learning and improvement of interventions over time.
