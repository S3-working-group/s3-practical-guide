...
-   [Evaluate and Evolve Policies](evaluate-and-evolve-policies.html) — Reviewing strategy and evolving it as necessary over time ensures it remains helpful and relevant to the organization, team, or role.
-   [Define and Monitor Metrics](define-and-monitor-metrics.html) — Defining criteria for success or failure is necessary for figuring out whether or not the strategy is effective.
