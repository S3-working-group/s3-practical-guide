...
-   [Clarify and Develop Domains](clarify-and-develop-domains.html) — for defining the scope and authority of the circle.
-   [Linking](linking.html) and [Double Linking](double-linking.html) — for connecting circles and enabling information flow and influence.
-   [Role Selection](role-selection.html) — for assigning specific responsibilities within the circle.
-   [Evaluate and Evolve Policies](evaluate-and-evolve-policies.html) — to continuously improve how the circle operates.
-   [Consent Decision Making](consent-decision-making.html) — for making decisions together.
-   [Proposal Forming](proposal-forming.html) — for collaborating on creating proposals. \
