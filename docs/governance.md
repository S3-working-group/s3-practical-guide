---
title: "Governance, Operations, Policy"
next_page_title: "Complexity"
next_page_url: "complexity.html"
...
Regular [evaluation of outcomes](evaluate-and-evolve-policies.html) ensures they are adapted, improved, or even discarded as circumstances change and people learn over time.
...
-   Distribution of responsibilities and authority to influence by [designing domains](clarify-and-develop-domains.html)
...
It's useful to [record policies](record-governance-decision.html)  to support their effective review and evolution. When describing policies, at the very least, include the following information:
...
-   in regular, dedicated [governance meetings](governance-meeting.html)
...
This [ongoing evolution of policies](evaluate-and-evolve-policies.html) supports the organization's ability to adapt, reducing the risk of stagnation and enabling continuous improvement. To ensure this, schedule regular evaluations of policies and resolve any objections promptly when they arise.
...
-   **[Determine Requirement](determine-requirements.html)** to decide on the scope and direction of the efforts
-   Determine intervention (in this case, a policy)
    -   **[Create a Proposal for a policy](proposal-forming.html)** that describes what will be done, which constraints will be put in place, etc.
    -   **[Resolve any Objections](resolve-objectins.html)** that have been identified to ensure the policy is adequate for fulfilling the requirement and responding to the driver
-   **[Evaluate and Policy and Evolve it as necessary](evaluate-and-evolve-policies.html)** to ensure it remains fit for purpose.

You'll find that similar steps apply to both operations and governance. For more information, see [Respond to Organizational Drivers](respond-to-organizational-drivers.html)
...
Every organization requires ongoing governance, both for the [whole system](manage-the-whole-system.html), and each <a href="glossary.html#entry-domain" class="glossary-tooltip" data-toggle="tooltip" title="Domain: A distinct area of responsibility and authority within an organization.">domain</a> within it.
...
Autonomy and coherence may appear contradictory, but in practice, they are complementary. Both need to be balanced and adjusted continually to maintain effectiveness across the organization. (See also: [Enable Autonomy](enable-autonomy.html) and [Collaborate on Dependencies](collaborate-on-dependencies.html)).
