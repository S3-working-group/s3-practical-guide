...
The Tuners do not make the final decision. Their responsibility is to produce a proposal that can later be evaluated, tested, and refined through the
 [Consent Decision Making process](consent-decision-making.html).
...
Once the proposal is ready, tuners share it with the rest of the group. The group can then evolve it further by [inviting and resolving objections](consent-decision-making.html) until an agreement is reached. 
