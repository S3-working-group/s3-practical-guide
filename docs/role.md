...
A role is a simple way for an organization (or <dfn data-info="Team: A group of people collaborating toward a shared driver (or objective).">team</dfn>) to delegate recurring tasks or a specific area of work and decision making to one of its members.
