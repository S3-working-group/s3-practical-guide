[:menu-title]: # "Orientation"

# Two Principles for Orientation

![Two Principles for Orientation: Clarify Purpose — Develop Strategy](img/csf/csf-light-orientation.png#limit=height;scale=small)
...
-   [Evaluate and Evolve Policies](section:evaluate-and-evolve-policies) — Reviewing strategy and evolving it as necessary over time ensures it remains helpful and relevant to the organization, team, or role.
