...
![](img/purposeful-action/purposeful-action-basic.png#limit:width;scale=small)
...
![](img/purposeful-action/understand-purpose.png#limit=width;scale=small)
...
![](img/purposeful-action/driver-requirement-table.png#limit=width;scale=full)
