...
Regular [evaluation of outcomes](section:evaluate-and-evolve-policies) ensures they are adapted, improved, or even discarded as circumstances change and people learn over time.
...
2. Determining what [requirement](glossary:requirement) is suitable to fulfill to address a driver. This clarifies the direction and scope of what will be done.
...
-   Distribution of responsibilities and authority to influence by [designing domains](section:clarify-and-develop-domains)
-   Selecting people to take on responsibility for domains
-   Distribution of resources
-   Decisions about how to handle dependencies between teams
-   Development of organizational, team, or product [strategies](glossary:strategy), etc.
...
-   in regular, dedicated [governance meetings](section:governance-meeting)
...
This [ongoing evolution of policies](section:evaluate-and-evolve-policies) supports the organization's ability to adapt, reducing the risk of stagnation and enabling continuous improvement. To ensure this, schedule regular evaluations of policies and resolve any objections promptly when they arise.
...
-   **[Determine Requirement](section:determine-requirements)** to decide on the scope and direction of the efforts
-   Determine intervention (in this case, a policy)
    -   **[Create a Proposal for a policy](section:proposal-forming)** that describes what will be done, which constraints will be put in place, etc.
    -   **[Resolve any Objections](section:resolve-objectins)** that have been identified to ensure the policy is adequate for fulfilling the requirement and responding to the driver
-   **[Evaluate and Policy and Evolve it as necessary](section:evaluate-and-evolve-policies)** to ensure it remains fit for purpose.

You'll find that similar steps apply to both operations and governance. For more information, see [Respond to Organizational Drivers](section:respond-to-organizational-drivers)
...
Autonomy and coherence may appear contradictory, but in practice, they are complementary. Both need to be balanced and adjusted continually to maintain effectiveness across the organization. (See also: [Enable Autonomy](section:enable-autonomy) and [Collaborate on Dependencies](section:collaborate-on-dependencies)).
