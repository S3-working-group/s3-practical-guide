...
![Visualization of a simple work process](img/workflow-and-value/simple-process.png#limit=width;scale=small)
...
![A card representing a work item](img/workflow-and-value/card.png#limit=width;scale=small)
