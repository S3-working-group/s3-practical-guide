...
Keep an up-to-date record of all governance decisions in a shared [logbook](glossary:logbook) or equivalent register. 

For guidance on what to record for drivers and requirements, see the patterns [Describe Organizational Drivers](section:describe-organizational-drivers) and [Determine Requirements](section:determine-requirements).
...
-   A description of the policy itself, which often includes one or more of these aspects: 
    ...
    -   Specific [deliverables](glossary:deliverable), the purpose they should fulfill, and for whom
    ...
    -   [Standard constraints](glossary:standard-constraint) that are relevant to keep in mind that might otherwise be overlooked by those with responsibility for execution or compliance
-   [Evaluation](section:evaluate-and-evolve-policies)
    -   [Metrics and Monitoring](section:metrics-and-monitoring) 
    -   Evaluation Schedule
    -   Information about any [concerns](glossary:concern)
-   Who is responsible for what?
