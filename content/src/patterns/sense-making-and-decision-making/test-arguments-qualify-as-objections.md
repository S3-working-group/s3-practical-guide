...
![Recursive application of testing arguments and investigating disagreements](img/policy/test-arguments-process.png#limit=width;scale=full)

![Facilitator's Guide: Test Arguments Qualify As Objections](img/policy/test-arguments-facilitation-guide.png#limit=width;scale=full)
