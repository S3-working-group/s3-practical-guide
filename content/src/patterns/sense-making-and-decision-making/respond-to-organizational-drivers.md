...
This process translates the **[concepts for purposeful action](section:purposeful-action)** into practical steps to navigate everyday work, so you can act with greater coherence and impact. The first three steps relate to clarifying [purpose](glossary:purpose), the next two to determining and implementing [interventions](glossary:intervention), and the final step covers evaluation of both purpose and intervention. 
...
Before responding to a situation, it is essential to verify that it is relevant for *the organization* to respond to (i.e., it qualifies as an [organizational driver](glossary:organizational-driver)) and that it is your responsibility to handle it.
...
-   **If it's outside your scope of responsibility, pass it on** to the appropriate person or team (see [Navigate via Tension](section:navigate-via-tension)). 
...
After establishing that a situation is both relevant to respond to and a priority, it's helpful to [determine the requirement](section:determine-requirements) before deciding on the specifics of an intervention (in the next step).
...
See [Determine Requirements](section:determine-requirements) for more information and examples.
...
-   [Proposal Forming](section:proposal-forming) — for co-creating solutions based on collective input.
-   [Consent Decision Making](section:consent-decision-making) — for surfacing and addressing objections before moving forward.
...
When planning an intervention, consider defining one or more metrics to help you track progress and assess effectiveness over time. Metrics act as early signals that indicate whether you're on track or if you need to adjust your approach. See [Define and Monitor Metrics](section:define-and-monitor-metrics) for support in identifying clear and meaningful metrics.
