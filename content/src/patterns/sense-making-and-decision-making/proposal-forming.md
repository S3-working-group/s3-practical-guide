...
![Proposal forming process](img/policy/proposal-forming.png#limit=width;scale=small)
...
Once the proposal is ready, tuners share it with the rest of the group. The group can then evolve it further by [inviting and resolving objections](section:consent-decision-making) until an agreement is reached. 
