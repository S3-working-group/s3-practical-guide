...
A role is an area of responsibility (a [domain](glossary:domain)) that is [delegated](glossary:delegation) to an individual (the **rolekeeper**), who has autonomy to decide and act within the constraints of the role's domain.

The rolekeeper leads in creating a [strategy](glossary:strategy) for how they will attend to their domain. They evolve their strategy in collaboration with the [delegator](glossary:delegator).
...
- rolekeepers are selected by consent and for a limited term
- peers support one another to develop in the roles they keep

A rolekeeper may maintain a governance [backlog](glossary:backlog), and a [logbook](glossary:logbook) to record and help them evolve their approach toward delivering [value](glossary:value).
