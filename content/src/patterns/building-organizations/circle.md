...
Members continuously decide together what to do to account for their domain, and set constraints on how and when things will be done. To that end, they maintain and evolve a body of [policies](glossary:policy). All members of a circle are equally accountable for work and [governance](glossary:governance) within the circle's domain.
