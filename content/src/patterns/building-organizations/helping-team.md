...
A helping team is a way for a [delegator](glossary:delegator) to **expand their capacity** by delegating work while retaining responsibility for all [governance ]()decisions concerning the team.  You can think of a Helping Team as a way for a delegator to extend their capacity with the help of some extra hands.

The delegator defines the rules, procedures, and constraints within which the team operates.

The team's primary responsibilities are **to execute tasks** and **inform the delegator** whenever they see the need for a governance decision (e.g., by adding it to the delegator's [governance backlog](glossary:governance-backlog)).

A Helping Team's members might have *more or less scope to organize their work*, and they might be guided by someone chosen by the delegator (see [Coordinator](section:coordinator)).
