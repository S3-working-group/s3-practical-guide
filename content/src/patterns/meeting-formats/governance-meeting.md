...
The main purpose of people’s efforts in any domain is to deliver value to the people they serve. This is mainly achieved during day-to-day activities ([operations](glossary:operations)). However, for operations to be and remain effective and efficient, it is essential to spend time regularly addressing  [governance](glossary:governance) matters: deciding on *how* you do things, evaluating the effectiveness of your policies, and addressing challenges and opportunities beyond the scope of individual work items. These activities often get lost when the operational workload is overwhelming, and deadlines are looming, which can lead to increased stress over time, systemic challenges not being addressed, and missed opportunities.
...
-   The [Governance Facilitator](section:governance-facilitator)
...
-   Any short reports
-   Evaluation of existing [policies](glossary:policy) (including domains) due for review
...
-   What people should do to **[prepare in advance](section:prepare-for-meetings)**
    -   Specific actions
