...
-   facilitate the meeting ([time box](glossary:time-box) dialogue and use rounds where valuable)
...
![Phases of a coordination meeting](img/meetings/coordination-meeting.png#limit=width;scale=small)
