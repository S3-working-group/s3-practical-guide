...
To make better use of their limited time, energy, and resources, people in organizations distribute work between them by creating roles or forming teams, units, or departments. In the process they are explicitly or implicitly designing [domains](glossary:domain) - distinct areas of responsibility and autonomy. 
...
Clarifying domains makes the contract between [delegator](glossary:delegator) and [delegatee(s)](glossary:delegatee) explicit, which enables everyone to learn about what works and what doesn’t, because everyone understands who is responsible for what. A clear domain description with a reasonable amount of detail is a necessary prerequisite for people to successfully evaluate and continuously improve their work.
