...
**Recommended Format**: Title, Description, Rate, Responsibilities, Baseline, Target and Triggers. Include Purpose if helpful. See [Define and Monitor Metrics](section:define-and-monitor-metrics) for more guidance on metrics. 
