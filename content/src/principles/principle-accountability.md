...
Many responsibilities are typically distributed throughout an organization by way of [delegation](), meaning that people take responsibility for specific work and decision making. Whenever a responsibility is delegated by one party (the [delegator](glossary:delegator)) to another party (the [delegatee(s)](glossary:delegatee)), accountability for results is shared between both parties. This is because either parties’ choices and actions (or inaction) will impact results. Furthermore the delegator is accountable for their decision to delegate these responsibilities, and for their decision about whom to delegate them to.
